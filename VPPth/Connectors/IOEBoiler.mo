...
connector IOEBoiler "Connection for heat pump"
  input PowerFit.Types.Power_MW Popt(start = 0) "electricity power of eboiler to be optimized";
  ...
  output PowerFit.Types.Power_MW PRef "electricity power of eboiler";
