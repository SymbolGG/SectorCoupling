...
connector IOGasBoiler "Connection for heat pump"
  input PowerFit.Types.Mode mode(start = 1) "0=Schedule/1=Optimized/2=Maintenance";
  input PowerFit.Types.Power_MW dQPlan(start = 0) "Planned/forecast Power";
  input PowerFit.Types.Power_MW dQopt(start = 0) "energy rate of the gas boiler to be optimized";
  input PowerFit.Types.Binary on(start = 1) "1: on, 0: off";
  input PowerFit.Types.SpecificCost_MWh CPGas(start = 20) "price for gas";
  output PowerFit.Types.Power_MW dQRef "energy rate of the gas boiler";
  output PowerFit.Types.Power_MW cgt_dQmax;
  output PowerFit.Types.Power_MW cgt_dQmin;
