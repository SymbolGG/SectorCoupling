...
model oulunenergia
  ...
  VPPth.Components.CHPth Chp2 annotation(
    Placement(visible = true, transformation(origin = {14, -20}, extent = {{-10, -10}, {10, 11}}, rotation = 0)));
  ...
  VPPth.Connectors.IOCHPth chp2 annotation(
    Placement(visible = true, transformation(origin = {-10, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-10, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  // input/output grid
...
equation
  ...
  connect(HeatStorage2.Heatport, Chp2.HeatPort) annotation(
  ...
  connect(Chp2.terminal, Grid.terminal_p) annotation(
    Line(points = {{24, -20}, {60, -20}, {60, 28}}, color = {0, 120, 120}));
  ...
  connect(EBoiler1.Heatport, Chp2.HeatPort) annotation(
    Line(points = {{4, -64}, {4, -26}}, color = {191, 0, 0}));
  connect(Chp1.HeatPort, Chp2.HeatPort) annotation(
    Line(points = {{4, 22}, {4, 22}, {4, -26}, {4, -26}}, color = {191, 0, 0}));
  connect(HeatLoad2.Heatport, Chp2.HeatPort) annotation(
    Line(points = {{-50, -26}, {4, -26}, {4, -26}, {4, -26}}, color = {191, 0, 0}));
  connect(HeatLoad1.Heatport, Chp1.HeatPort) annotation(
    Line(points = {{-50, 22}, {4, 22}, {4, 22}, {4, 22}}, color = {191, 0, 0}));
  connect(chp2, Chp2.IO) annotation(
    Line(points = {{-10, -20}, {4, -20}, {4, -20}, {4, -20}}));
